...
public final class GoodsFactory {
    ...
    private static class AssetsProfit {
        static final int APPLE_PROFIT = 2;
        static final int CHEESE_PROFIT = 3;
        static final int BREAD_PROFIT = 4;
        static final int CHICKEN_PROFIT = 4;
        static final int TOMATO_PROFIT = 3;
        static final int CORN_PROFIT = 2;
        static final int POTATO_PROFIT = 3;
        static final int WINE_PROFIT = 5;
        static final int SALT_PROFIT = 2;
        static final int SUGAR_PROFIT = 3;

        static final int SILK_PROFIT = 9;
        static final int PEPPER_PROFIT = 8;
        static final int BARREL_PROFIT = 7;
        static final int BEER_PROFIT = 6;
        static final int SEAFOOD_PROFIT = 12;
    }

    private static class KingBonus {
        static final int APPLE = 20;
        static final int CHEESE = 19;
        static final int BREAD = 18;
        static final int CHICKEN = 17;
        static final int TOMATO = 16;
        static final int CORN = 15;
        static final int POTATO = 14;
        static final int WINE = 13;
        static final int SALT = 12;
        static final int SUGAR = 11;
    }

    private static class QueenBonus {
        static final int APPLE = 10;
        static final int CHEESE = 9;
        static final int BREAD = 9;
        static final int CHICKEN = 8;
        static final int TOMATO = 7;
        static final int CORN = 6;
        static final int POTATO = 5;
        static final int WINE = 4;
        static final int SALT = 3;
        static final int SUGAR = 2;
    }
    ...
    private static class IllegalBonus {
        ...
        static final int SEAFOOD_BONUS_TOMATO = 2;
        static final int SEAFOOD_BONUS_POTATO = 3;
        static final int SEAFOOD_BONUS_CHICKEN = 1;
    }
    ...
    private void initIllegalGoods() {
        ...
        Map<Goods, Integer> bonus0 = new HashMap<>();
        Map<Goods, Integer> bonus1 = new HashMap<>();
        Map<Goods, Integer> bonus2 = new HashMap<>();
        Map<Goods, Integer> bonus3 = new HashMap<>();
        Map<Goods, Integer> bonus4 = new HashMap<>();
